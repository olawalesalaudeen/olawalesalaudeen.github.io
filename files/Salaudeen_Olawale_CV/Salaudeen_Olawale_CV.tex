...
\textit{\say{Adapting to Shifts in Latent Confounders using Observed Concepts and Proxies}}.
...
\textbf{\underline{Olawale Salaudeen}}, Natalie Ramsy, Davide Boido, Serge Charpak, Andrew Webb, Luisa Ciobanu.
\say{\textit{Ultra-fast 3D fMRI to explore cardiac-induced fluctuations in BOLD-based functional imaging}}.
...
\say{\textit{Exploiting Causal Chains for Domain Generalization}}
