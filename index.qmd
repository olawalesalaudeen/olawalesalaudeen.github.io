...
::: {.direction-box}
### Measuring and Mitigating Disparate AI Behavior

AI systems can behave inequitably across the populations they serve, through biased labels, misinterpreted subgroup evaluations, or ranking objectives misaligned with user welfare. I develop tools to measure these disparities and methods to mitigate them in deployed systems.
