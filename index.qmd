...
::: {.direction-box}
### Societal Impact of AI: Fairness and Equitable Deployment

AI systems can encode and amplify disparities, especially when subgroup labels are noisy, evaluations are misinterpreted, or ranking objectives are misaligned with user welfare. I study how to measure and mitigate these harms so AI is deployed equitably across populations.
